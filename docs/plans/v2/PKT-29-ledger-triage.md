# PKT-29 — Ledger triage + the lore_index identity line (FIRST work packet)
size ~0.15 wu · pre-wave (runs before C2a) · depends: none
...
3. **Routing table applied** (operator-approved 2026-07-14) — every open/acknowledged
   ...
   | #21 #29 #35 #48 | individual verdicts here (largely delivered by map/impact/C0-verbs/reference-doc; residue → PKT-17 or C3) |
   ...
   | #105 | C2c |
   | #89 #121 | C3 |
   | #118 #119 #128 (+#126 #127 adjudication) | PKT-30 |
   | #24 | PKT-08 (rescoped) |
   | #15 #64 #80(ack) #82 #84 #85 #86 #88 #92 | PKT-03 |
   | #83(ack) #87 | PKT-01/02 |
   | #10 #11 #27 | PKT-04/05 |
   | #26 #28 #72 | PKT-09a; #12 → PKT-09b |
   | #109 #110 #113 #114 #116 #117 | PKT-31 |
   | #13 | PKT-11 |
   | #125 | PKT-33 design → PKT-34 build; honesty line ships HERE |
   | #3(ack) #20 #37 #40 #41 | PKT-17 |
   | #124(ack) | watch (observability support via PKT-31/#109) |
