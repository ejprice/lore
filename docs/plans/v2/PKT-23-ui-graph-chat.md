# PKT-23 — UI graph explorer + Agent-SDK chat (MASTER-PLAN §8.8 closes here)
size ~0.35 wu · wave G, LAST · depends: PKT-21, PKT-22
...
- **Chat**: Claude Agent SDK session server-side, wired to THIS project's own lore MCP
  ...
  config). Auth per PKT-21's posture — chat is an outward-facing surface.
...
## Entry check
PKT-22's endpoints live; PKT-21 posture allows the chat exposure planned.
