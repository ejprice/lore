...
## Mission
Build the PKT-04 contract through the TDD 5-phase cycle (STUB → RED → GREEN → REFACTOR):
...
## Entry check
PKT-04 contract tests exist and are RED; suite snapshot green otherwise; spike-surreal up.
