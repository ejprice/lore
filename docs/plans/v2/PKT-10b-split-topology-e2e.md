# PKT-10b — Split-topology end-to-end (split from PKT-10, 2026-07-14; MASTER-PLAN §8.7)
size ~0.20 wu · wave S · depends: PKT-07, PKT-08b
law: DESIGN-LAW §12 · DEPLOY: receipts run against real containers (no new code expected)

## Mission
The split-topology half of the original PKT-10, deferred with the client/server wave.
(The single-node §8.6 drills + the watcher skip-path drill stayed in PKT-10a, wave M —
...
## Entry check
PKT-07 roles + PKT-08b images live; a throwaway drill store provisioned (per-drill
