# PKT-16 — Sweep detectors + raise_issue escalation
...
- Detectors, opt-in per kind in lore.yaml: **dead_code** (existing analysis),
  **undocumented** (chunk metadata; PKT-15's seeding path if it landed), **drift**
...
## Scope OUT
- trace_monitor auto-filing (PKT-20 — it needs the deepened traces).
