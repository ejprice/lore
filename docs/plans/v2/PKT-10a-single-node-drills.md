# PKT-10a — Single-node resilience drills (MASTER-PLAN §8.6) — SPLIT 2026-07-14
...
(The §8.7 split-topology e2e half moved to **PKT-10b**, wave S, with the client/server
...
- **§8.6 drills** on the unified store: kill -9 mid-sweep; corrupt-dir resilient open
  (move aside, recreate, eager rebuild — memories-unrecovered honesty per PKT-24's
...
## Scope OUT / warnings
- Split-topology e2e (PKT-10b, wave S).
...
never spike-surreal's test data mid-suite); PKT-24's landed state checked (the
