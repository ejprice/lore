...
## Mission
Build the PKT-01 design: per-instance floor measurement persisted in that instance's
...
- Reranker/utility-predictor confidence layers (PKT-17 territory).

## Entry check
- PKT-01 ruling recorded; suite snapshot green at current HEAD; spike-surreal up.
