# PKT-08 — The astroid shadow (finding #24) — RESCOPED 2026-07-14
size ~0.15 wu · wave L (parallel-safe) · depends: none
law: DESIGN-LAW §4 (graph invariants), §12 · DEPLOY: yes
(The Containerfile role rework half moved to **PKT-08b**, wave S, with the client/server
...
## Scope OUT
- Containerfile role rework / image slimming (PKT-08b, wave S). Split-topology drills
  (PKT-10b). Recreate-rebuild behavior is WONTFIX by design (memory:
