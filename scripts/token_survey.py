...
# The percentile seam is imported for the SAME reason, from the other side of this
# merge (#198): one implementation, in the installed package. Packet 42 and #198
# reached this file independently and their imports are both kept — a merge that
# picked one would have silently reverted the other's whole point.
