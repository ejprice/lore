...
The paired-decomposition check compares the floor computed over the surviving manifest subset
against the floor computed over the full pool:

| surviving subset | full pool | equal | paired floor | full floor | equal |
|---|---|---|---|---|---|
| 456 | 456 | ✓ | `0.456789` | `0.456789` | ✓ |
